package com.tm.bottomsheet.bottomsheetdemo.behavior;
...
public class MyBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    //距离顶部的offset
    private int mAnchorPoint = DEFAULT_ANCHOR_POINT;
    ...
    public MyBehavior(Context context, AttributeSet attrs ) {
        ...
        if (attrs != null) {
            ...
            mMinOffset = (int) a.getDimension(R.styleable.CustomBottomSheetBehavior_min_offset, 0);
        }
        a.recycle();
